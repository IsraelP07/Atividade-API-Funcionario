using AtividadeFuncionario_Israel;
...
namespace Funcionario_Israel.Controllers
{
    ...
    public class FuncionarioController : ControllerBase
    {
        ...
        private List<Funcionario> ObterFuncionarios()
        {
            ...
            if (System.IO.File.Exists(ArquivoFuncionarios))
            {
                ...
                foreach (var linha in linhas)
                {
                    ...
                    {
                        Console.WriteLine("Dados mal formatados na linha: " + linha);
                    }
                }
            }
            else
            {
                Console.WriteLine("Arquivo não encontrado: " + ArquivoFuncionarios);
            }
        ...
        {
            if (!VerificarCPF(cpf)) 
                // "!" verifica se uma condição é não verdadeira de acordo com o que estudei,
               // pode ser retirado, mas usando deixa mais eficaz a validação professor.
              // Se não for verdadeiro, aparece a mensagem. 
            {
